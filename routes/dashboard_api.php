...
Route::middleware(['auth:dashboard'])->group(function () {
    Route::prefix('api')->group(function () {
        Route::get('users', [UsersApiController::class, 'index'])->name('dashboard.api.users.index');
        Route::post('users', [UsersApiController::class, 'store'])->name('dashboard.api.users.store');
        Route::put('users/{id}', [UsersApiController::class, 'update'])->name('dashboard.api.users.update');
        Route::delete('users/{id}', [UsersApiController::class, 'destroy'])->name('dashboard.api.users.destroy');
